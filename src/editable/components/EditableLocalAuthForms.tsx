...
const inputClass = 'h-[3.25rem] border border-black/20 bg-white px-4 text-base font-bold text-[#172235] outline-none transition placeholder:text-[#6b7280] focus:border-[var(--slot4-accent)]'
const buttonClass = 'inline-flex h-[3.25rem] items-center justify-center bg-[var(--slot4-accent)] px-6 text-xs font-extrabold uppercase tracking-[0.16em] text-white transition hover:bg-[#bd3c20] disabled:opacity-60'
